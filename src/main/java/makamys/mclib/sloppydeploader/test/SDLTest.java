...
public class SDLTest {
    ...
    static {
        SloppyDepLoaderAPI.addDependenciesForMod(
            Loader.instance()
                .activeModContainer()
                .getModId(),
            new SloppyDependency(
                "https://github.com/makamys/UpdateCheckLib/releases/download/" + SDLTest.UCL_VERSION,
                "UpdateCheckLib-" + Loader.MC_VERSION + "-" + SDLTest.UCL_VERSION + ".jar",
                "makamys.updatechecklib.UpdateCheckLib"),
            new SloppyDependency("garbage url", "JarThatWillNeverExist-1.7.10-0.0.jar", "class.that.will.never.Exist"));
