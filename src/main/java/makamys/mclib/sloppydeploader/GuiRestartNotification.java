...
public class GuiRestartNotification extends GuiYesNo {
    ...
    public void initGui() {
        ...
        this.buttonList
            .add(new GuiOptionButton(1, this.width / 2 - 155 + 160, this.height - 32, this.cancelButtonText));
    }
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
        ...
        this.drawCenteredString(
            ...
            "The following optional dependencies have been downloaded:",
            this.width / 2,
            y,
            0xFFFFFF);
        y += 18;
        ...
        this.drawCenteredString(
            this.fontRendererObj,
            "A game restart is needed to activate them.",
            this.width / 2,
            y,
            0xFFFFFF);
        y += 12;
