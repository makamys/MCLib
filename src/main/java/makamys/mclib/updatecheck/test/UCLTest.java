...
public class UCLTest {
    ...
    private void initUpdateCheck() {
        ...
        String mock_1_0 = MockHelper.uploadMockText(
            "mock://1.0.json",
            new UpdateJsonBuilder().version("1.0")
                .build());
        String mock_1_1 = MockHelper.uploadMockText(
            "mock://1.1.json",
            new UpdateJsonBuilder().version("1.1")
                .build());
        String mock_1_0_homepages = MockHelper.uploadMockText(
            "mock://1.0-homepages.json",
            new UpdateJsonBuilder().version("1.0")
                .homepage("GitHub", "https://github.com/")
                .homepage("CurseForge", "https://curseforge.com/")
                .homepage("Modrinth", "https://modrinth.com/")
                .build());
        String mock_1_0_troll = MockHelper.uploadMockText(
            "mock://1.0-troll.json",
            new UpdateJsonBuilder().version("1.0")
                .homepage("TrollHub", "\"></a><script>alert(\"trolled (using homepage url)\");</script><a href=\"")
                .build());

        // outdated mod via network (json returns 1.7.10-35.4.1 as the version and
        // https://github.com/makamys/MAtmos/releases as the homepage as of now)
        uc.submitModTask(
            MODID,
            "https://raw.githubusercontent.com/makamys/MAtmos/master/updatejson/update-matmos.json");
        ...
        uc.submitTask(
            "</td><script>alert(\"trolled (using mod name)\");</script><td>",
            "0.8",
            UpdateCheckAPI.MODS_CATEGORY_ID,
            mock_1_0_troll);
        ...
        uc.submitTask(
            ...
            "0.1",
            "matmosSoundpacks",
            "https://raw.githubusercontent.com/makamys/MAtmos/master/updatejson/update-mat_zen.json");
    }
