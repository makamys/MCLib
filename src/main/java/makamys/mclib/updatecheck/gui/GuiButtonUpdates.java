package makamys.mclib.updatecheck.gui;
...
public class GuiButtonUpdates extends GuiButtonGeneric {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        if (updateCount == -1) {
            displayString = new String[] { GRAY + "." + DARK_GRAY + "..",
                DARK_GRAY + "." + GRAY + "." + DARK_GRAY + ".",
                DARK_GRAY + ".." + GRAY + "." }[(int) ((System.nanoTime() / 1000000000) % 3)];
        }
    ...
    public List<String> getTooltipStrings() {
        if (updateCount >= 0) {
            ...
            return Arrays.asList(GRAY + "Checking for updates...");
        }
    }
