...
/**
 * Redirects method invocations of a field's object to the equivalent field inside the newest version of the library
 * present.
 * <br>
 * (Equivalence here means the fields have the same name, and the enclosing class has the same canonical class name
 * relative to mclib package.)
 */
public class SharedModuleMethodRedirector implements MethodInterceptor {
    ...
    public SharedModuleMethodRedirector(Field field) {
        this.field = field;
        this.isNewest = field.getDeclaringClass()
            .getName()
            .startsWith(SharedLibHelper.getNewestLibPackage());
    }
    ...
    public Object intercept(Object obj, Method method, Object[] args, MethodProxy proxy) throws Throwable {
        if (isNewest) {
            ...
            Method otherMethod = otherField.getType()
